    ...
    data: [
      {
        ...
        price_range: '3~5',
        images: ['https://images.unsplash.com/photo-1617196034796-73dfa7b1fd56?w=800&auto=format&fit=crop'],
        isFavorite: true,
        featured: {
      ...
      },
      {
        ...
        name: '스시 긴자 이시카와',
        price_range: '4~6',
        images: ['https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=800&auto=format&fit=crop'],
        isFavorite: false,
        featured: {
          text: '도쿄의 상위 스시 맛집',
          icon: 'stars-02'
      ...
      },
      {
        ...
        name: '라멘 이치란',
        price_range: '2~4',
        images: ['https://images.unsplash.com/photo-1632709810780-b5a4343cebec?w=800&auto=format&fit=crop'],
        isFavorite: true,
      ...
      },
      {
        ...
        name: '텐푸라 마츠야',
        price_range: '3~5',
        images: ['https://images.unsplash.com/photo-1569050467447-ce54b3bbc37d?w=800&auto=format&fit=crop'],
        isFavorite: false,
      ...
      },
      {
        ...
        name: '우동 타로',
        price_range: '2~4',
        images: ['https://images.unsplash.com/photo-1552611052-33e04de081de?w=800&auto=format&fit=crop'],
        isFavorite: true,
      ...
      },
      {
        ...
        name: '야키토리 하치베',
        price_range: '1~3',
        images: ['https://images.unsplash.com/photo-1519624014191-508652cbd7b5?w=800&auto=format&fit=crop'],
        isFavorite: false,
      ...
      },
      {
        ...
        name: '스시 사토',
        price_range: '4~6',
        images: ['https://images.unsplash.com/photo-1563612116625-3012372fccce?w=800&auto=format&fit=crop'],
        isFavorite: true,
      ...
      },
      {
        ...
        name: '라멘 타츠야',
        price_range: '2~4',
        images: ['https://images.unsplash.com/photo-1591814468924-caf88d1232e1?w=800&auto=format&fit=crop'],
        isFavorite: false,
      ...
      },
      {
        ...
        name: '우동 가게야마',
        price_range: '2~4',
        images: ['https://images.unsplash.com/photo-1618841557871-b4664fbf0cb3?w=800&auto=format&fit=crop'],
        isFavorite: false,
